                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                @foreach($typeofcodes as $typeCode)
                                <tr>
                                    <td>{{$typeCode -> id}}</td>
                                    <td>{{$typeCode -> name}}</td>
                                    <td><i class="fa fa-pencil fa-fw"></i><a href="admin/typecode/edit/{{$typeCode->id}}">Edit</a></td>
                                    <td><i class="fa fa-trash-o fa-fw"></i><a href="admin/typecode/delete/{{$typeCode->id}}">Delete</a></td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
