                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><i class="fa fa-pencil fa-fw"></i><a href="admin/location/edit/{{$loc->id}}">Edit</a></td>
                                    <td><i class="fa fa-trash-o fa-fw"></i><a href="admin/location/delete/{{$loc->id}}">Delete</a></td>
