                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                @foreach($tag as $pritag)
                                    <tr>
                                        <td>{{$pritag -> id}}</td>
                                        <td>{{$pritag -> pricetag}}</td>
                                        <td><i class="fa fa-pencil fa-fw"></i><a href="admin/pricetag/edit/{{$pritag->id}}">Edit</a></td>
                                        <td><i class="fa fa-trash-o fa-fw"></i><a href="admin/pricetag/delete/{{$pritag->id}}">Delete</a></td>
