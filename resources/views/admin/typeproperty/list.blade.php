                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    <td>{{$typePro -> id}}</td>
                                    <td>{{$typePro -> typeProperty}}</td>
                                    <td><i class="fa fa-pencil fa-fw"></i><a href="admin/typeproperty/edit/{{$typePro->id}}">Edit</a></td>
                                    <td><i class="fa fa-trash-o fa-fw"></i><a href="admin/typeproperty/delete/{{$typePro->id}}">Delete</a></td>
