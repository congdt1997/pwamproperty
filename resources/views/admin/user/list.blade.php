                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                @foreach($user as $usr)
                                    <tr>
                                        <td><img width="200px" height="150px" src="admin_asset/images/upload/user/{{$usr->image}}"></td>
                                        <td>{{$usr -> id}}</td>
                                        <td>{{$usr -> idRole}}</td>
                                        <td>{{$usr -> fullname}}</td>
                                        <td>{{$usr -> email}}</td>
                                        ...
                                        <td>{{$usr -> address}}</td>
                                        <td><i class="fa fa-pencil fa-fw"></i><a href="admin/user/edit/{{$usr->id}}">Edit</a></td>
                                        <td><i class="fa fa-trash-o fa-fw"></i><a href="admin/user/delete/{{$usr->id}}">Delete</a></td>
