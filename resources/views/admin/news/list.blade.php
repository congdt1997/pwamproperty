                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                @foreach($news as $ns)
                                <tr>
                                    <td><img width="250px" height="150px" src="admin_asset/images/upload/news/{{$ns->image}}"></td>
                                    <td>{{$ns -> id}}</td>
                                    <td>{{$ns -> title}}</td>
                                    <td>{{$ns -> content}}</td>
                                    <td><i class="fa fa-pencil fa-fw"></i><a href="admin/news/edit/{{$ns->id}}">Edit</a></td>
                                    <td><i class="fa fa-trash-o fa-fw"></i><a href="admin/news/delete/{{$ns->id}}">Delete</a></td>
