...
@section('content')
    <section class="breadcrumbs-custom bg-image context-dark" data-opacity="37" style="background-image: url(images/breadcrumbs-bg-05-1922x441.jpg);">
        <div class="container">
                            ...
                            <article class="block-callboard">
                                <div class="block-callboard-body">
                                    ...
                                    <ul class="block-callboard-list">
                                        <li>
                                            <div class="block-callboard-tell"><a href="tel:0962222782">096 2222 782</a></div>
                                        </li>
                                        <li>
                                            <div class="block-callboard-mail"><a href="mailto:pwam.realestate@gmail.com">pwam.realestate@gmail.com</a></div>
                                        </li>
                                    </ul><a class="button button-block button-secondary" href="contact-us.html">Contact us</a>
                                </div>
                            </article>
                        </div>
                        <div class="col-md-6 col-lg-12">
