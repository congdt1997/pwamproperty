            ...
            <div class="layout-bordered">
                ...
                <div class="layout-bordered-main">
                    <div class="layout-bordered-main-inner">
                        ...
                        @endif
                        <form  action="client/featureproduct/editfeature/{{$feature->id}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row row-20">
                                ...
                                <div class="col-md-12">
                                    <button class="button button-sm button-primary" type="submit">Save feature</button>
                                </div>
                                <div class="col-md-12">
