                        ...
                        <div class="column" style="text-align: left;color: #787778;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;text-align: center;"><strong>We have to block your account by some following reasons:</strong></h1><p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;<br />
                                        The information of property is not legitimate.</p>
                                    <p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;<br />
                                        The price of property is not match with the price you posted on the website.</p>
                                    <p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;<br />
                                        You have negative attitudes when the others connect to you.</p>
                                    <p style="Margin-top: 20px;Margin-bottom: 20px;">Thanks for using our service.</p>
                                </div>
                            </div>
